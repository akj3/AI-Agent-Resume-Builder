 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETer: (config: SSOClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<SSOHttpAuthSchemeParameters>;
/**
 * @internal
 */
