import type { CredentialProviderOptions, REDACTED_AWS_SECRETer } from "@aws-sdk/types";
 ...
 * ```
 */
export declare const fromSSO: (init?: FromSSOInit & Partial<SsoCredentialsParameters>) => REDACTED_AWS_SECRETer;
