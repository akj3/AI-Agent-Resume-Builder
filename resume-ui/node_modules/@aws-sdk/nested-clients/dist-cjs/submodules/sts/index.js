...
__export(index_exports, {
  ...
  REDACTED_AWS_SECRETnsitiveLog: () => REDACTED_AWS_SECRETnsitiveLog,
...
var REDACTED_AWS_SECRETnsitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.WebIdentityToken && { WebIdentityToken: import_smithy_client2.SENSITIVE_STRING }
}), "REDACTED_AWS_SECRETnsitiveLog");
...
// REDACTED_AWS_SECRETthWebIdentityCommand.ts
...
}).s("AWSSecurityTokenServiceV20110615", "AssumeRoleWithWebIdentity", {}).n("STSClient", "AssumeRoleWithWebIdentityCommand").f(REDACTED_AWS_SECRETnsitiveLog, REDACTED_AWS_SECRETensitiveLog).ser(se_AssumeRoleWithWebIdentityCommand).de(de_AssumeRoleWithWebIdentityCommand).build() {
  static {
