 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETnsitiveLog: (obj: AssumeRoleWithWebIdentityRequest) => any;
/**
...
export interface AssumeRoleWithWebIdentityResponse {
     ...
     *          token. To learn more about OIDC tokens and claims, see <a href="https://docs.aws.amazon.REDACTED_AWS_SECRET-cognito-user-pools-using-tokens-with-identity-providers.html">Using Tokens with User Pools</a> in the <i>Amazon Cognito Developer Guide</i>.
 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETensitiveLog: (obj: AssumeRoleWithWebIdentityResponse) => any;
/**
