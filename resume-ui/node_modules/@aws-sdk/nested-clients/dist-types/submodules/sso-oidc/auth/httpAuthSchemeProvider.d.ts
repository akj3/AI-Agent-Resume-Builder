 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETovider: (config: SSOOIDCClientResolvedConfig, context: HandlerExecutionContext, input: object) => Promise<SSOOIDCHttpAuthSchemeParameters>;
/**
 * @internal
 */
