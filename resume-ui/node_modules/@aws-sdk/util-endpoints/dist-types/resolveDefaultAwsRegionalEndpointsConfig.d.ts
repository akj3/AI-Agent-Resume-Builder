 ...
 * @internal
 */
export interface REDACTED_AWS_SECRETg {
 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRET: <T>(input: T & DefaultAwsRegionalEndpointsInputConfig & PreviouslyResolved) => T & REDACTED_AWS_SECRETg;
/**
 * @internal
 */
