...
import {
  REDACTED_AWS_SECRETdInput,
  REDACTED_AWS_SECRETdOutput,
} from "..REDACTED_AWS_SECRETtityCommand";
import {
  GetPrincipalTagAttributeMapCommandInput,
  REDACTED_AWS_SECRET,
} from "..REDACTED_AWS_SECRETmand";
import {
...
} from "..REDACTED_AWS_SECRET";
import {
  MergeDeveloperIdentitiesCommandInput,
  MergeDeveloperIdentitiesCommandOutput,
} from "..REDACTED_AWS_SECRETd";
import {
...
export declare const se_REDACTED_AWS_SECRETd: (
  input: REDACTED_AWS_SECRETdInput,
  context: __SerdeContext
) => Promise<__HttpRequest>;
...
export declare const de_REDACTED_AWS_SECRETd: (
  output: __HttpResponse,
  context: __SerdeContext
) => Promise<REDACTED_AWS_SECRETdOutput>;
export declare const de_GetPrincipalTagAttributeMapCommand: (
  output: __HttpResponse,
  context: __SerdeContext
) => Promise<REDACTED_AWS_SECRET>;
