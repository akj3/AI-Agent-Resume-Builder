...
export declare const REDACTED_AWS_SECRETitiveLog: (
  obj: GetCredentialsForIdentityInput
) => any;
export declare const CredentialsFilterSensitiveLog: (obj: Credentials) => any;
export declare const REDACTED_AWS_SECRETensitiveLog: (
...
export declare const REDACTED_AWS_SECRET: (
  obj: GetOpenIdTokenResponse
) => any;
export declare const REDACTED_AWS_SECRETilterSensitiveLog: (
  obj: GetOpenIdTokenForDeveloperIdentityInput
) => any;
export declare const REDACTED_AWS_SECRETseFilterSensitiveLog: (
  obj: REDACTED_AWS_SECRETse
) => any;
