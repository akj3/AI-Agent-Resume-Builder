 ...
 */
export interface REDACTED_AWS_SECRET extends GetPrincipalTagAttributeMapResponse, __MetadataBearer {
}
declare const GetPrincipalTagAttributeMapCommand_base: {
    new (input: GetPrincipalTagAttributeMapCommandInput): import("@smithy/smithy-client").CommandImpl<GetPrincipalTagAttributeMapCommandInput, REDACTED_AWS_SECRET, CognitoIdentityClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
    new (input: GetPrincipalTagAttributeMapCommandInput): import("@smithy/smithy-client").CommandImpl<GetPrincipalTagAttributeMapCommandInput, REDACTED_AWS_SECRET, CognitoIdentityClientResolvedConfig, ServiceInputTypes, ServiceOutputTypes>;
 ...
 * @returns {@link REDACTED_AWS_SECRET}
 * @see {@link GetPrincipalTagAttributeMapCommandInput} for command's `input` shape.
 * @see {@link REDACTED_AWS_SECRET} for command's `response` shape.
