...
import { GetCredentialsForIdentityCommandInput, GetCredentialsForIdentityCommandOutput } from ".REDACTED_AWS_SECRETnd";
...
import { REDACTED_AWS_SECRETdInput, REDACTED_AWS_SECRETdOutput } from ".REDACTED_AWS_SECRETtityCommand";
import { GetPrincipalTagAttributeMapCommandInput, REDACTED_AWS_SECRET } from ".REDACTED_AWS_SECRETmand";
...
import { LookupDeveloperIdentityCommandInput, LookupDeveloperIdentityCommandOutput } from ".REDACTED_AWS_SECRET";
import { MergeDeveloperIdentitiesCommandInput, MergeDeveloperIdentitiesCommandOutput } from ".REDACTED_AWS_SECRETd";
import { SetIdentityPoolRolesCommandInput, SetIdentityPoolRolesCommandOutput } from "./commands/SetIdentityPoolRolesCommand";
import { SetPrincipalTagAttributeMapCommandInput, REDACTED_AWS_SECRET } from ".REDACTED_AWS_SECRETmand";
import { TagResourceCommandInput, TagResourceCommandOutput } from "./commands/TagResourceCommand";
import { UnlinkDeveloperIdentityCommandInput, UnlinkDeveloperIdentityCommandOutput } from ".REDACTED_AWS_SECRET";
...
export interface CognitoIdentity {
    ...
    /**
     * @see {@link REDACTED_AWS_SECRETd}
     */
    getOpenIdTokenForDeveloperIdentity(args: REDACTED_AWS_SECRETdInput, options?: __HttpHandlerOptions): Promise<REDACTED_AWS_SECRETdOutput>;
    getOpenIdTokenForDeveloperIdentity(args: REDACTED_AWS_SECRETdInput, cb: (err: any, data?: REDACTED_AWS_SECRETdOutput) => void): void;
    getOpenIdTokenForDeveloperIdentity(args: REDACTED_AWS_SECRETdInput, options: __HttpHandlerOptions, cb: (err: any, data?: REDACTED_AWS_SECRETdOutput) => void): void;
    /**
     * @see {@link GetPrincipalTagAttributeMapCommand}
     */
    getPrincipalTagAttributeMap(args: GetPrincipalTagAttributeMapCommandInput, options?: __HttpHandlerOptions): Promise<REDACTED_AWS_SECRET>;
    getPrincipalTagAttributeMap(args: GetPrincipalTagAttributeMapCommandInput, cb: (err: any, data?: REDACTED_AWS_SECRET) => void): void;
    getPrincipalTagAttributeMap(args: GetPrincipalTagAttributeMapCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: REDACTED_AWS_SECRET) => void): void;
    /**
     ...
     */
    setPrincipalTagAttributeMap(args: SetPrincipalTagAttributeMapCommandInput, options?: __HttpHandlerOptions): Promise<REDACTED_AWS_SECRET>;
    setPrincipalTagAttributeMap(args: SetPrincipalTagAttributeMapCommandInput, cb: (err: any, data?: REDACTED_AWS_SECRET) => void): void;
    setPrincipalTagAttributeMap(args: SetPrincipalTagAttributeMapCommandInput, options: __HttpHandlerOptions, cb: (err: any, data?: REDACTED_AWS_SECRET) => void): void;
    /**
