...
/**
 * serializeAws_json1_REDACTED_AWS_SECRETnd
 */
export declare const se_REDACTED_AWS_SECRETd: (input: REDACTED_AWS_SECRETdInput, context: __SerdeContext) => Promise<__HttpRequest>;
/**
...
/**
 * deserializeAws_json1_REDACTED_AWS_SECRETnd
 */
export declare const de_REDACTED_AWS_SECRETd: (output: __HttpResponse, context: __SerdeContext) => Promise<REDACTED_AWS_SECRETdOutput>;
/**
 * deserializeAws_json1_1GetPrincipalTagAttributeMapCommand
 */
export declare const de_GetPrincipalTagAttributeMapCommand: (output: __HttpResponse, context: __SerdeContext) => Promise<REDACTED_AWS_SECRET>;
/**
 ...
 */
export declare const de_SetPrincipalTagAttributeMapCommand: (output: __HttpResponse, context: __SerdeContext) => Promise<REDACTED_AWS_SECRET>;
/**
