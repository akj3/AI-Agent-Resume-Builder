...
export interface CreateIdentityPoolInput {
     ...
     *             <a href="https://docs.aws.amazon.REDACTED_AWS_SECRETtication-flow.html">Identity Pools (Federated Identities) Authentication Flow</a> in the
...
export interface GetCredentialsForIdentityInput {
     ...
     *          examples in the <a href="https://docs.aws.amazon.REDACTED_AWS_SECRETal-identity-providers.html">External Identity
 ...
 * @public
 */
export declare class REDACTED_AWS_SECRETn extends __BaseException {
    readonly name: "REDACTED_AWS_SECRETn";
    readonly $fault: "client";
    /**
     * @internal
     */
    constructor(opts: __ExceptionOptionType<REDACTED_AWS_SECRETn, __BaseException>);
}
/**
 ...
 * @public
 */
export interface REDACTED_AWS_SECRETse {
    /**
     * <p>A unique identifier in the format REGION:GUID.</p>
     * @public
     */
 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETitiveLog: (obj: GetCredentialsForIdentityInput) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETensitiveLog: (obj: GetCredentialsForIdentityResponse) => any;
/**
 * @internal
 */
 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRET: (obj: GetOpenIdTokenResponse) => any;
/**
 * @internal
 */
export declare const REDACTED_AWS_SECRETilterSensitiveLog: (obj: GetOpenIdTokenForDeveloperIdentityInput) => any;
/**
 * @internal
 */
export declare const REDACTED_AWS_SECRETseFilterSensitiveLog: (obj: REDACTED_AWS_SECRETse) => any;
/**
 * @internal
 */
