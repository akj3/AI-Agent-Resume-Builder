...
__export(index_exports, {
  ...
  REDACTED_AWS_SECRETitiveLog: () => REDACTED_AWS_SECRETitiveLog,
  REDACTED_AWS_SECRETensitiveLog: () => REDACTED_AWS_SECRETensitiveLog,
  ...
  REDACTED_AWS_SECRETd: () => REDACTED_AWS_SECRETd,
  REDACTED_AWS_SECRETilterSensitiveLog: () => REDACTED_AWS_SECRETilterSensitiveLog,
  REDACTED_AWS_SECRETseFilterSensitiveLog: () => REDACTED_AWS_SECRETseFilterSensitiveLog,
  GetOpenIdTokenInputFilterSensitiveLog: () => GetOpenIdTokenInputFilterSensitiveLog,
  REDACTED_AWS_SECRET: () => REDACTED_AWS_SECRET,
  GetPrincipalTagAttributeMapCommand: () => GetPrincipalTagAttributeMapCommand,
  InternalErrorException: () => InternalErrorException,
  REDACTED_AWS_SECRETn: () => REDACTED_AWS_SECRETn,
  ...
  constructor(...[configuration]) {
    ...
    this.middlewareStack.use(
      (0, import_core.getHttpAuthSchemeEndpointRuleSetPlugin)(this.config, {
        httpAuthSchemeParametersProvider: import_httpAuthSchemeProvider.REDACTED_AWS_SECRETmetersProvider,
...
var REDACTED_AWS_SECRETn = class _REDACTED_AWS_SECRETn extends CognitoIdentityServiceException {
  static {
    __name(this, "REDACTED_AWS_SECRETn");
  }
  name = "REDACTED_AWS_SECRETn";
  $fault = "client";
  /**
   * @internal
   */
  constructor(opts) {
    ...
    Object.setPrototypeOf(this, _REDACTED_AWS_SECRETn.prototype);
  }
};
...
var REDACTED_AWS_SECRETitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Logins && { Logins: import_smithy_client.SENSITIVE_STRING }
}), "REDACTED_AWS_SECRETitiveLog");
var CredentialsFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.SecretKey && { SecretKey: import_smithy_client.SENSITIVE_STRING }
}), "CredentialsFilterSensitiveLog");
var REDACTED_AWS_SECRETensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Credentials && { Credentials: CredentialsFilterSensitiveLog(obj.Credentials) }
}), "REDACTED_AWS_SECRETensitiveLog");
...
var REDACTED_AWS_SECRET = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Token && { Token: import_smithy_client.SENSITIVE_STRING }
}), "REDACTED_AWS_SECRET");
var REDACTED_AWS_SECRETilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Logins && { Logins: import_smithy_client.SENSITIVE_STRING }
}), "REDACTED_AWS_SECRETilterSensitiveLog");
var REDACTED_AWS_SECRETseFilterSensitiveLog = /* @__PURE__ */ __name((obj) => ({
  ...obj,
  ...obj.Token && { Token: import_smithy_client.SENSITIVE_STRING }
}), "REDACTED_AWS_SECRETseFilterSensitiveLog");
...
var se_REDACTED_AWS_SECRETd = /* @__PURE__ */ __name(async (input, context) => {
  const headers = sharedHeaders("GetOpenIdTokenForDeveloperIdentity");
  let body;
  body = JSON.stringify((0, import_smithy_client._json)(input));
  return buildHttpRpcRequest(context, headers, "/", void 0, body);
}, "se_REDACTED_AWS_SECRETd");
...
var de_REDACTED_AWS_SECRETd = /* @__PURE__ */ __name(async (output, context) => {
  if (output.statusCode >= 300) {
    return de_CommandError(output, context);
  }
  const data = await (0, import_core2.parseJsonBody)(output.body, context);
...
var de_CommandError = /* @__PURE__ */ __name(async (output, context) => {
  ...
  switch (errorCode) {
    ...
    case "REDACTED_AWS_SECRETn":
    case "com.amazonaws.cognitoidentity#REDACTED_AWS_SECRETn":
      throw await de_REDACTED_AWS_SECRETnRes(parsedOutput, context);
    case "DeveloperUserAlreadyRegisteredException":
    case "com.amazonaws.cognitoidentity#DeveloperUserAlreadyRegisteredException":
      throw await de_REDACTED_AWS_SECRETes(parsedOutput, context);
...
var de_REDACTED_AWS_SECRETes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, import_smithy_client._json)(body);
...
var de_REDACTED_AWS_SECRETnRes = /* @__PURE__ */ __name(async (parsedOutput, context) => {
  const body = parsedOutput.body;
  const deserialized = (0, import_smithy_client._json)(body);
  const exception = new REDACTED_AWS_SECRETn({
    $metadata: deserializeMetadata(parsedOutput),
    ...deserialized
  });
  return (0, import_smithy_client.decorateServiceException)(exception, body);
}, "de_REDACTED_AWS_SECRETnRes");
...
}).s("AWSCognitoIdentityService", "GetCredentialsForIdentity", {}).n("CognitoIdentityClient", "GetCredentialsForIdentityCommand").f(REDACTED_AWS_SECRETitiveLog, REDACTED_AWS_SECRETensitiveLog).ser(se_GetCredentialsForIdentityCommand).de(de_GetCredentialsForIdentityCommand).build() {
  static {
...
}).s("AWSCognitoIdentityService", "GetOpenIdToken", {}).n("CognitoIdentityClient", "GetOpenIdTokenCommand").f(GetOpenIdTokenInputFilterSensitiveLog, REDACTED_AWS_SECRET).ser(se_GetOpenIdTokenCommand).de(de_GetOpenIdTokenCommand).build() {
  static {
    __name(this, "GetOpenIdTokenCommand");
  }
};

// REDACTED_AWS_SECRETdentityCommand.ts



var REDACTED_AWS_SECRETd = class extends import_smithy_client.Command.classBuilder().ep(commonParams).m(function(Command, cs, config, o) {
  return [
    (0, import_middleware_serde.getSerdePlugin)(config, this.serialize, this.deserialize),
    (0, import_middleware_endpoint.getEndpointPlugin)(config, Command.getEndpointParameterInstructions())
  ];
}).s("AWSCognitoIdentityService", "GetOpenIdTokenForDeveloperIdentity", {}).n("CognitoIdentityClient", "REDACTED_AWS_SECRETd").f(
  REDACTED_AWS_SECRETilterSensitiveLog,
  REDACTED_AWS_SECRETseFilterSensitiveLog
).ser(se_REDACTED_AWS_SECRETd).de(de_REDACTED_AWS_SECRETd).build() {
  static {
    __name(this, "REDACTED_AWS_SECRETd");
  }
};

// REDACTED_AWS_SECRETCommand.ts
