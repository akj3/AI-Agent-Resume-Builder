...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function REDACTED_AWS_SECRETeded(controller) {
        var shouldPull = REDACTED_AWS_SECRETll(controller);
        if (!shouldPull) {
            return;
        }
    ...
    function REDACTED_AWS_SECRETtoDescriptor(stream, pullIntoDescriptor) {
        ...
        var filledView = REDACTED_AWS_SECRETntoDescriptor(pullIntoDescriptor);
    ...
    function REDACTED_AWS_SECRETsedState(controller, firstDescriptor) {
        ...
        if (ReadableStreamHasBYOBReader(stream)) {
            while (ReadableStreamGetNumReadIntoRequests(stream) > 0) {
                var pullIntoDescriptor = REDACTED_AWS_SECRETPullInto(controller);
    ...
    function REDACTED_AWS_SECRETll(controller) {
        ...
        var desiredSize = REDACTED_AWS_SECRETze(controller);
        if (desiredSize > 0) {
            return true;
        }
        return false;
    ...
    function WritableStreamDefaultWriterWrite(writer, chunk) {
        var stream = writer._ownerWritableStream;
        var controller = stream._writableStreamController;
        var chunkSize = REDACTED_AWS_SECRETize(controller, chunk);
    ...
    function SetUpWritableStreamDefaultController(stream, controller, startAlgorithm, writeAlgorithm, closeAlgorithm, abortAlgorithm, highWaterMark, sizeAlgorithm) {
        ...
        var backpressure = REDACTED_AWS_SECRETessure(controller);
    ...
    function REDACTED_AWS_SECRETessure(controller) {
        var desiredSize = REDACTED_AWS_SECRETdSize(controller);
    ...
    function ReadableStreamPipeTo(source, dest, preventClose, preventAbort, preventCancel, signal) {
        ...
        return newPromise(function (resolve, reject) {
            ...
            isOrBecomesClosed(source, reader._closedPromise, function () {
                if (!preventClose) {
                    shutdownWithAction(function () { return REDACTED_AWS_SECRETrPropagation(writer); });
                }
                else {
                    shutdown();
                }
    ...
    function REDACTED_AWS_SECRETfNeeded(controller) {
        var shouldPull = REDACTED_AWS_SECRETlPull(controller);
        if (!shouldPull) {
            return;
        }
        if (controller._pulling) {
    ...
    function ReadableByteStreamTee(stream) {
        ...
        function pull1Algorithm() {
            ...
            reading = true;
            var byobRequest = REDACTED_AWS_SECRETst(branch1._readableStreamController);
            if (byobRequest === null) {
        ...
        function pull2Algorithm() {
            ...
            reading = true;
            var byobRequest = REDACTED_AWS_SECRETst(branch2._readableStreamController);
            if (byobRequest === null) {
                pullWithDefaultReader();
            }
            else {
    ...
    function TransformStreamDefaultControllerEnqueue(controller, chunk) {
        ...
        var backpressure = REDACTED_AWS_SECRETessure(readableController);
