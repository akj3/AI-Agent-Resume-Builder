...
import type { REDACTED_AWS_SECRETypes, REDACTED_AWS_SECRETpes, StreamingBlobPayloadInputTypes } from "../streaming-payload/streaming-blob-payload-input-types";
 ...
 * ```
 */
export type NodeJsClient<ClientType extends object> = NarrowPayloadBlobTypes<REDACTED_AWS_SECRETpes, SdkStream<IncomingMessage>, ClientType>;
/**
 * @public
 * Variant of NodeJsClient for node:http2.
 */
export type NodeJsHttp2Client<ClientType extends object> = NarrowPayloadBlobTypes<REDACTED_AWS_SECRETpes, SdkStream<ClientHttp2Stream>, ClientType>;
/**
 * @public
 *
 * Creates a type with a given client type that narrows payload blob output
 ...
 * ```
 */
export type BrowserClient<ClientType extends object> = NarrowPayloadBlobTypes<REDACTED_AWS_SECRETypes, SdkStream<ReadableStream>, ClientType>;
/**
 * @public
 *
 * Variant of BrowserClient for XMLHttpRequest.
 */
export type BrowserXhrClient<ClientType extends object> = NarrowPayloadBlobTypes<REDACTED_AWS_SECRETypes, SdkStream<ReadableStream | Blob>, ClientType>;
/**
 * @public
 *
