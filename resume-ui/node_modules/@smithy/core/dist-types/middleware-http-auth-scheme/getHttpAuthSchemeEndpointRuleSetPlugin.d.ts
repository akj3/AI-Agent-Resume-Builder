 ...
 * @internal
 */
export declare const REDACTED_AWS_SECRETptions: SerializeHandlerOptions & RelativeMiddlewareOptions;
/**
 * @internal
 */
interface REDACTED_AWS_SECRETns<TConfig extends object, TContext extends HandlerExecutionContext, TParameters extends HttpAuthSchemeParameters, TInput extends object> {
